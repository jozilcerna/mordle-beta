...
this.wordle.bundle = function(e) {
    ...
    var Ma = ["acads", "admin", "agham", "altis", "archi", "ariel", "ateng", "batch", "brana", "break", "cerla", "class", "cores", "crisp", "dante", "dorms", "edgar", "eisen", "elvin", "fries", "gmeet", "grade", "guard", "honor", "hugot", "integ", "jomar", "julna", "lando", "lunch", "mapeh", "meets", "merch", "metro", "mialo", "music", "myrna", "notes", "party", "pisay", "pizza", "ramos", "rigel", "robot", "roden", "rosal", "rusty", "sampa", "scale", "shake", "shena", "sinco", "staff", "stage", "stats", "study", "tanoy", "truth", "virna", "walks", "works", "youth"]
      , Oa = ["acads", "admin", "agham", "altis", "archi", "ariel", "ateng", "batch", "brana", "break", "cerla", "class", "cores", "crisp", "dante", "dorms", "edgar", "eisen", "elvin", "fries", "gmeet", "grade", "guard", "honor", "hugot", "integ", "jomar", "julna", "lando", "lunch", "mapeh", "meets", "merch", "metro", "mialo", "music", "myrna", "notes", "party", "pisay", "pizza", "ramos", "rigel", "robot", "roden", "rosal", "rusty", "sampa", "scale", "shake", "shena", "sinco", "staff", "stage", "stats", "study", "tanoy", "truth", "virna", "walks", "works", "youth"]
      , Ra = "present"
      , Ha = "correct"
      , Na = "absent";
    var Pa = {
